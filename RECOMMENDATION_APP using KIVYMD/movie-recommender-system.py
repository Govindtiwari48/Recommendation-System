{
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "movies=pd.read_csv(r\"/Users/govindtiwari/Documents/ Python Codes/application using kivy/START_APP/tmdb_5000_movies.csv\")\n",
    "credits=pd.read_csv(r\"/Users/govindtiwari/Documents/ Python Codes/application using kivy/START_APP/tmdb_5000_credits.csv\")"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "/var/folders/51/_bp7zy656n9cp2jx6sfgrvt80000gn/T/ipykernel_93790/487797088.py:1: SettingWithCopyWarning: \n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "/var/folders/51/_bp7zy656n9cp2jx6sfgrvt80000gn/T/ipykernel_93790/3514595201.py:1: SettingWithCopyWarning: \n",
      "A value is trying to be set on a copy of a slice from a DataFrame.\n",
      "Try using .loc[row_indexer,col_indexer] = value instead\n",
      "\n",
      "See the caveats in the documentation: https://pandas.pydata.org/pandas-docs/stable/user_guide/indexing.html#returning-a-view-versus-a-copy\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "/var/folders/51/_bp7zy656n9cp2jx6sfgrvt80000gn/T/ipykernel_93790/3393644922.py:2: SettingWithCopyWarning: \n",
      "A value is trying to be set on a copy of a slice from a DataFrame.\n",
      "Try using .loc[row_indexer,col_indexer] = value instead\n",
      "\n",
      "See the caveats in the documentation: https://pandas.pydata.org/pandas-docs/stable/user_guide/indexing.html#returning-a-view-versus-a-copy\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "#Represent all the tags in a vector format and recommend any 5 movie's vector closest to the input movie's vector\n",
    "#->text converted to vectors(text vectorization)\n",
    "#->techniques ->bag of words(simplest,one which we are gonna use), ->tfidf,->word2vec\n",
    "#->bag of words->We'll combine all the tags into a one single large tag and from that we'll extract some N numbers of most \n",
    "#                commonly used words\n",
    "#Now,for eg.: We'll apply operations on tags column and will get a table of 5000 most commonly occuring words\n",
    "#         Action|Future......Alien\n",
    "#movie1     5     2            1\n",
    "#movie2     3     1            4\n",
    "#.\n",
    "#.\n",
    "#.\n",
    "#Now each row is a vector containing which commonly occuring word occured how many time in that movie's tag\n",
    "#We'll not include stop words in the table of \"commonly occuring words\"\n",
    "#Stop words:Words which are used for sentence formation eg. is,an,are etc."
   ]
  },
  {
   "cell_type": "code",
